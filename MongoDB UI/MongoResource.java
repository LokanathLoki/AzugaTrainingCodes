...
public class MongoResource {
    ...
    @GET
    @Produces(MediaType.APPLICATION_JSON)
    public ArrayList<Document> sort(@PathParam("order") String order ){
        data = (object.sorting(order));
        return data;
    }
    ...
    @GET
    @Produces(MediaType.APPLICATION_JSON)
    public ArrayList<Document> search(@PathParam("data") String order ){
        data = (object.textSearch(order));
        return data;
    }
    ...
    @GET
    @Produces(MediaType.APPLICATION_JSON)
    public ArrayList<Document> pagination(@PathParam("data") int page ){
        data = (object.pagination(page));
        return data;
    }
}
